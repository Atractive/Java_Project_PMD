...
public class ControlerAR {
	...
	private void description(){
		Text text1=new Text("Si vous ne savez pas comment marche notre système de recherche, voici une petite aide! ;)");
	...
	private void Desc_favoris(){
		...
		Text text2 = new Text("Vous avez le choix entre choisir une image en favoris ou non ou alors ne pas prendre en compte le tri favoris");
	...
	private void Desc_notes(){
		...
		Text text2=new Text("Vous avez le choix de vouloir des images notés de 1 à 5 (Vous pouvez choisir différentes notes");
		text2.setFont(new Font(15));
	...
	private void Desc_couleurs(){
		...
		Text description = new Text("Ecrivez les couleurs que vous voulez parmis : (possibilité choix multiple) \n");
	...
	private void Desc_Mots_clé(){
		...
		Text text2= new Text("Choissisez les mots clés afin d'avoir les images que vous voulez voir s'afficher");
		text2.setFont(new Font(15));
	...
	private void Desc_Classement(){
		...
		Text text2=new Text("Choississez votre Classement parmis la taille, le poids et le nombre d'ouvertures");
		text2.setFont(new Font(15));
